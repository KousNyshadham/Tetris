...
public class JTetris extends JComponent {
    ...
    //proper piece generation
    protected int index = 0;
    protected List<Piece> properPieceGeneration = new ArrayList<Piece>();
    ...
    public Piece pickNextPiece() {
    	if(index == 0) {
    		properPieceGeneration = Arrays.asList(PIECES);
    		Collections.shuffle(properPieceGeneration);
    	}
    	Piece piece = properPieceGeneration.get(index);
    	index = (index+1) % 7;
    	return piece;
    }
